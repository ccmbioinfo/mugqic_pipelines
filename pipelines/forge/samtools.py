...
#This first cram_2_fastq (currently commented out) is an alternative to the cram_2_fastq method below it, which implements piping.
#Both versions take about 30-40min
'''
