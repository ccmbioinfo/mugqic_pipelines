...
bwa aln -t 4 $COW_CDS $input_dir/cow1_qual_unique_n_rRNA.fastq > $output_dir/cow1_host.sai
bwa aln -t 4 $COW_CDS $input_dir/cow2_qual_unique_n_rRNA.fastq > $output_dir/cow2_host.sai

bwa sampe $COW_CDS $output_dir/cow1_host.sai $output_dir/cow2_host.sai $output_dir/cow1_matching_ids.fastq $output_dir/cow2_matching_ids.fastq > $output_dir/cow_host.sam
