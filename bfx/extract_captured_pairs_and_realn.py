...
def extract_captured_pairs_and_realn(captured_bam, realigned_bam, hg_and_trans_junc_ref=None, ini_section='extract_captured_pairs_and_realn'):
	...
	return Job(
		...
		command="""\
/hpf/largeprojects/ccmbio/jiangyue/DIPG_analysis_by_samples/Scripts/extract_fusion_pairs.py {captured_bam} && \\
