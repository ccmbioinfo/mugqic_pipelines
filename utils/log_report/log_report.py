...
def parse_args():
    ...
    parser.add_argument('-dy', '--dependency_first', help="Display an indented text showing job dependencies from first completed to last completed", action='store_true')
    parser.add_argument('-dr', '--depender_first', help="Display an indented text showing job dependencies from last completed to first completed", action='store_true')
    ...
    if not (args.report or args.dependency_first or args.depender_first):
        parser.error('One of --report, --dependency_first, or --depender_first is required')
